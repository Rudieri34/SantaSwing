...
namespace TheraBytes.BetterUi.Editor.ThirdParty {
	...
	/// </summary>
	/// <remarks>
	/// <para>This adaptor can be subclassed to add special logic to type height calculation.
	...
	/// cloned using that interface upon duplication; otherwise the type value or reference is
	/// simply copied.</para>
	/// </remarks>
	...
	public class GenericListAdaptor<T> : IReorderableListAdaptor {
		...
		/// <summary>
		/// Fixed height of each list type.
		/// </summary>
		...
		/// <param name="itemDrawer">Callback to draw list type.</param>
		/// <param name="itemHeight">Height of list type in pixels.</param>
