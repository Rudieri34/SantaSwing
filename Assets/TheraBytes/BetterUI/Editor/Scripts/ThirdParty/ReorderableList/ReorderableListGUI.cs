...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public static class ReorderableListGUI {
		...
		/// <summary>
		/// Default list type height is 18 pixels.
		/// </summary>
		public const float DefaultItemHeight = 18;

		/// <summary>
		/// Gets or sets the zero-based index of the last type that was changed. A value of -1
		/// indicates that no type was changed by list.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Default list type drawer implementation.
		/// </summary>
		/// <remarks>
		/// <para>Always presents the label "Item drawer not implemented.".</para>
		/// </remarks>
		/// <param name="position">Position to draw list type control(s).</param>
		/// <param name="item">Value of list type.</param>
		/// <returns>
		/// Unmodified value of list type.
		/// </returns>
		/// <typeparam name="T">Type of list type.</typeparam>
		...
		/// <para>Value of <c>GUI.changed</c> is set to <c>true</c> if value of type
		/// is modified.</para>
		/// </remarks>
		/// <param name="position">Position to draw list type control(s).</param>
		/// <param name="item">Value of list type.</param>
		/// <returns>
		/// Modified value of list type.
		/// </returns>
		...
		/// <param name="drawItem">Callback to draw list type.</param>
		/// <param name="drawEmpty">Callback to draw custom content for empty list (optional).</param>
		/// <param name="itemHeight">Height of a single list type.</param>
