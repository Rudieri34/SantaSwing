...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public interface IReorderableListAdaptor {
		...
		/// <summary>
		/// Determines whether an type can be reordered by dragging mouse.
		/// </summary>
		/// <remarks>
		/// <para>This should be a light-weight method since it will be used to determine
		/// whether grab handle should be included for each type in a reorderable list.</para>
		/// <para>Please note that returning a value of <c>false</c> does not prevent movement
		/// on list type since other draggable items can be moved around it.</para>
		/// </remarks>
		/// <param name="index">Zero-based index for list element.</param>
		/// <returns>
		/// A value of <c>true</c> if type can be dragged; otherwise <c>false</c>.
		/// </returns>
		bool CanDrag(int index);
		/// <summary>
		/// Determines whether an type can be removed from list.
		/// </summary>
		/// <remarks>
		/// <para>This should be a light-weight method since it will be used to determine
		/// whether remove button should be included for each type in list.</para>
		/// <para>This is redundant when <see cref="ReorderableListFlags.HideRemoveButtons"/>
		/// is specified.</para>
		/// </remarks>
		/// <param name="index">Zero-based index for list element.</param>
		/// <returns>
		/// A value of <c>true</c> if type can be removed; otherwise <c>false</c>.
		/// </returns>
		...
		/// <summary>
		/// Draws background of a list type.
		/// </summary>
		/// <remarks>
		/// <para>This method is only used to handle GUI repaint events.</para>
		/// <para>Background of list type spans a slightly larger area than the main
		...
		/// <summary>
		/// Draws main interface for a list type.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Gets height of list type in pixels.
		/// </summary>
		/// <param name="index">Zero-based index of array element.</param>
		/// <returns>
