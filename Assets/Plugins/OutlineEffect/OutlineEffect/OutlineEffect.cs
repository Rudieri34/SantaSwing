...
public class OutlineEffect : MonoBehaviour
{
	...
	private readonly LinkedSet<ItemOutline> outlines = new LinkedSet<ItemOutline>();
	...
	public void OnPreRender()
	{
		...
		foreach (ItemOutline outline in outlines)
		{
	...
	{
		ItemOutline[] o = FindObjectsOfType<ItemOutline>();
		if (autoEnableOutlines)
		{
			foreach (ItemOutline oL in o)
			{
				oL.enabled = false;
				oL.enabled = true;
			}
	...
	public void AddOutline(ItemOutline outline)
		 => outlines.Add(outline);

	public void RemoveOutline(ItemOutline outline)
